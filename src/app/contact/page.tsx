          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="mailto:sales@shahankhalidllc.com" className="text-blue-600 hover:text-blue-800 text-lg">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="tel:+15123555445" className="text-blue-600 hover:text-blue-800 text-lg">
                      +1 (512) 355-5445
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 text-lg">Business Address</h3>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white py-3 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors font-semibold text-lg"
                >
                  Send Message
                </button>
              </form>
